...
export default function BlogCard(props) {
  return (
    <div  className={`border-2 border-blue-400 hover:text-white  hover-effect bg-slate-50  hover:border-blue-700 text-black hover:bg-blue-700 ease-in duration-300 py-4 pb-10 ${props.hid} ` } >
